...
namespace MeshCombineStudio
{
    public class ObjectOctree
    {
        ...
        public class Cell : BaseOctree.Cell
        {
            ...
            {
                Vector3 position;
                if (meshCombiner.searchOptions.objectCenter == MeshCombiner.ObjectCenter.TransformPosition) position = cachedGO.t.position; else position = cachedGO.mr.bounds.center;
